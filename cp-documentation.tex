...
Mit der Version \texttt{v1.2} kam dann die Paketoption \T{lithieboxes} hinzu (Gegenoption: \T{nolithieboxes}). Diese hat nur einen Effekt wenn auch \T{enumitem} aktiv ist, sorgt dann aber dafür, dass die damit gesetzten Farben sich an die jeweilige Box anpassen. Eine Unterstützung für \T{hyperref} ist aktuell nicht geplant da für diese Handhabung \T{lecture-links} aus der \href{https://github.com/EagleoutIce/lithie-util}{lithie-util} Sammlung eine viel bessere Unterstützung liefert.
...
Die \hyperref[sec:packetoptions]{Paketoption} \texttt{enumitem} wurde hinzugefügt.
