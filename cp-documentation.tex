...
\begin{command}[v1.1]{WithPalette}{\manArg{Name}\manArg{Text/Code}}
    Setzt \arg{Text/Code} in der Palette mit Bezeichner \arg{Name}.
\end{command}
...
Die \hyperref[sec:packetoptions]{Paketoptionen} \texttt{hyperref} und \texttt{enumitem} wurden hinzugefügt. Einige Paletten wurden aktualisiert und die Befehle \cmdref{SetShadeContrast}, wie auch \cmdref{WithPalette} eingeführt.
