...
\label{sec:packetoptions}Das Paket selbst kann alle Optionen für \paletteA{color-palettes} akzeptieren, die dann entsprechend weitergereicht werden. Weiter unterstützt es die Option \T{loadpkgs}, die standardmäßig aktiv ist und automatisch das Paket \T{tikz} läd. Dieses Verhalten kann durch die Option \T{noloadpkgs} unterdrückt werden.
...
Option zum automatischen Laden von Paketen (\T{loadpkgs}) hinzugefügt.
